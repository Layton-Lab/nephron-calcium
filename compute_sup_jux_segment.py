...
def compute_segment(sup_or_jux,sex,species,sup_or_multi,diabete,inhib,unx,preg,HT,file_to_save):
    ...
    pt, fluxvals_pt =compute(NPT,filename,'Broyden',sup_or_jux,diabete,species,sup_or_multi=sup_or_multi,inhibition = inhib,unx = unx, preg = preg, HT=HT)
    ...
    if sex == 'Male':
        ...
        filename ='./datafiles/S3params_F_'+species[0:3]+'.dat'
    s3, fluxvals_s3=compute(NS3,filename,'Newton',  sup_or_jux,diabete,species,sup_or_multi=sup_or_multi,inhibition = inhib,unx = unx,preg = preg, HT = HT)
    ...
    sdl, fluxvals_sdl =compute(NSDL,filename,method ,sup_or_jux,diabete,species,sup_or_multi=sup_or_multi,inhibition = inhib,unx = unx, preg = preg, HT = HT)
    ...
    if sup_or_jux != 'sup':
        ...
        if sex == 'Male':
            ...
            filename ='./datafiles/LDLparams_F_'+species[0:3]+'.dat'
        ldl, fluxvals_ldl =compute(NLDL,filename,'Newton' ,sup_or_jux,diabete,species,sup_or_multi=sup_or_multi,inhibition = inhib,unx = unx, preg = preg, HT = HT)
    ...
    #========================================================
        ...
        if sex == 'Male':
            ...
            filename ='./datafiles/LALparams_F_rat.dat'
        lal, fluxvals_lal =compute(NLAL,filename,'Newton' ,sup_or_jux,diabete,species,sup_or_multi=sup_or_multi,inhibition = inhib,unx = unx, preg = preg, HT = HT)
    ...
    if sex == 'Male':
        ...
        filename ='./datafiles/mTALparams_F_'+species[0:3]+'.dat'
    mtal, fluxvals_mtal =compute(NmTAL,filename,'Newton' ,sup_or_jux,diabete,species,sup_or_multi,inhib,unx = unx, preg = preg, HT = HT)
    ...
    if sex == 'Male':
        ...
        filename ='./datafiles/cTALparams_F_'+species[0:3]+'.dat'
    ctal, fluxvals_ctal=compute(NcTAL,filename,'Newton' ,sup_or_jux,diabete,species,sup_or_multi,inhib,unx = unx, preg = preg, HT = HT)
    ...
    if sex == 'Male':
        ...
        filename ='./datafiles/DCTparams_F_'+species[0:3]+'.dat'
    dct, fluxvals_dct =compute(NDCT,filename,'Newton' ,sup_or_jux,diabete,species,sup_or_multi,inhib,unx = unx, preg = preg, HT = HT)
    ...
    if sex == 'Male':
        ...
        filename ='./datafiles/CNTparams_F_'+species[0:3]+'.dat'
    cnt, fluxvals_cnt =compute(NCNT,filename,'Newton' , sup_or_jux,diabete,species,sup_or_multi,inhib,unx = unx, preg = preg, HT = HT)
