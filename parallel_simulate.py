...
parser.add_argument('--inhibition',choices=['ACE','SGLT2','NHE3-50','NHE3-80','NKCC2-70','NKCC2-100','NCC-70','NCC-100',
                                            'ENaC-70','ENaC-100','SNB-70','SNB-100', 'TRPV5-99'],default = None,type = str,help = 'any transporter inhibition?')
...
if __name__ == '__main__':
    ...
    if sex == 'Male':
        ...
        filename = './datafiles/CCDparams_F_' + species[0:3] + '.dat'
    ccd, fluxvals_ccd = compute(NCCD, filename, 'Newton', diabete=diabete, species=species, sup_or_multi=sup_or_multi, inhibition=inhib, unx=unx, preg=preg, HT=HT)
    ...
    if sex == 'Male':
        ...
        filename = './datafiles/OMCDparams_F_' + species[0:3] + '.dat'
    omcd, fluxvals_omcd = compute(NOMCD, filename, 'Newton', diabete=diabete, species=species, sup_or_multi=sup_or_multi, inhibition=inhib, unx=unx, preg=preg, HT=HT)
    ...
    if sex == 'Male':
        ...
        filename = './datafiles/IMCDparams_F_' + species[0:3] + '.dat'
    imcd, fluxvals_imcd = compute(NIMCD, filename, 'Newton', diabete=diabete, species=species, sup_or_multi=sup_or_multi, inhibition=inhib, unx=unx, preg=preg, HT=HT)
